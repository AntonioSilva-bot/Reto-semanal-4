...
def seg_linea(image):
    ...
    if len(cnts) > 0:
        x, y, b, g = cv2.boundingRect(cnts[0])
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        if z == 1 and k == 1 and a2 == 1:
            ...
            control_a = (accion_proporcional_a + accion_integral_a + accion_deribativa_a) / 10
            control_d = (accion_proporcional_d + accion_integral_d) / 10
            if control_a > 0.2:
                control_a = 0.2
            if control_d > 0.2:
                control_d = 0.2
            ...
            print_info = "%3f | %3f " % (control_a, control_d)
            # print_info = "%3f | %3f " %(control_a,w2)
